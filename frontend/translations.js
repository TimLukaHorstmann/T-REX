...
window.translationDict = {
  ...
  fr: {
    ...
    gptOss20bDesc: "Modèle open-source 20B d'OpenAI",
    phi4Desc: "Idéal pour la vérification des faits dans les tableaux",
    qwen3Desc: "Généraliste multilingue",
  ...
  de: {
    ...
    gptOss20bDesc: "OpenAI's Open-Source 20B Modell",
    phi4Desc: "Hervorragend für die Faktenprüfung von Tabellen",
    qwen3Desc: "Mehrsprachiger Generalist",
  ...
  es: {
    ...
    gptOss20bDesc: "Modelo open-source 20B de OpenAI",
    phi4Desc: "Excelente para la verificación de hechos en tablas",
    qwen3Desc: "Generalista multilingüe",
  ...
  pt: {
    ...
    gptOss20bDesc: "Modelo open-source 20B da OpenAI",
    phi4Desc: "Ótimo para verificação de fatos em tabelas",
    qwen3Desc: "Generalista multilíngue",
  ...
  zh: {
    ...
    gptOss20bDesc: "OpenAI 的开源 20B 模型",
    phi4Desc: "非常适合表格事实核查",
    qwen3Desc: "多语言通用模型",
  ...
  ar: {
    ...
    gptOss20bDesc: "نموذج 20B مفتوح المصدر من OpenAI",
    phi4Desc: "رائع للتحقق من صحة الحقائق في الجداول",
    qwen3Desc: "نموذج متعدد اللغات عام",
  ...
  ru: {
    ...
    gptOss20bDesc: "Открытая модель 20B от OpenAI (лучшее качество)",
    phi4Desc: "Отлично подходит для проверки фактов в таблицах",
    qwen3Desc: "Многоязычная универсальная модель",
