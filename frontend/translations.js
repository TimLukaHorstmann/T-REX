...
window.translationDict = {
  en: {
    ...
    clientEngine: "Client-side OCR (default)",
    serverEngine: "Server-side OCR",
  ...
  fr: {
    ...
    clientEngine: "OCR côté client (par défaut)",
    serverEngine: "OCR côté serveur",
  ...
  de: {
    ...
    clientEngine: "Clientseitige OCR (Standard)",
    serverEngine: "Serverseitige OCR",
  ...
  es: {
    ...
    clientEngine: "OCR en el lado del cliente (predeterminado)",
    serverEngine: "OCR en el lado del servidor",
    ...
    abortMessage: "Verificación en vivo cancelada.",
  ...
  pt: {
    ...
    clientEngine: "OCR no lado do cliente (padrão)",
    serverEngine: "OCR no lado do servidor",
    ...
    abortMessage: "Verificação ao vivo cancelada.",
  ...
  ar: {
    ...
    clientEngine: "التعرف الضوئي على الحروف من جهة العميل (افتراضي)",
    serverEngine: "التعرف الضوئي على الحروف من جهة الخادم",
    ...
    abortMessage: "تم إلغاء الفحص المباشر.",
    answerLabel: "الإجابة",
    trueLabel: "صحيح",
    falseLabel: "خطأ",
  ...
  ru: {
    ...
    clientEngine: "OCR на стороне клиента (по умолчанию)",
    serverEngine: "OCR на стороне сервера",
    ...
    abortMessage: "Проверка в реальном времени отменена.",
    answerLabel: "Ответ",
    trueLabel: "Истина",
    falseLabel: "Ложь",
